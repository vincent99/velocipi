// Sparkfun VEML6030 ambient expander
...
func (v *Expander) Init() error {
	...
	if err := v.SetDirection(0xffff); err != nil {
	...
	if err := v.SetPullUp(0xffff); err != nil {
		return errors.New("expander could not be set pull-up resistors: " + err.Error())
	}

	if err := v.SetInterrupts(0xffff, 0x0000, 0x0000); err != nil {
