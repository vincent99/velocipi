...
import { Key, Knob, Window } from './window';
...
export class Page extends EventEmitter {
  ...
  // Key presses
  public onKey(_which: Key, _dur: 'short' | 'long') {}

  // Knob turns
  public onKnob(_which: Knob, _dir: 'left' | 'right') {}

  // Lower-level key events for when a key is pushed down, held, and released
  public onKeyHeld(_which: Key) {}
  public onKeyDown(_which: Key) {}
  public onKeyUp(_which: Key) {}
}
